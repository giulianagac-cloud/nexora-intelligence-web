...
export const metadata: Metadata = {
  title: 'Bots con IA | NEXORA Intelligence',
  description: 'Chatbots inteligentes para atención al cliente, RRHH y gestión interna. Tu negocio responde 24/7 sin intervención humana.',
}
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{ overflow: 'hidden', borderRadius: '4px', border: '1px solid var(--border)' }}>
            <img src="/bots.png" alt="Bot con IA Nexora" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '96px 64px', background: 'var(--deep)', borderBottom: '1px solid var(--border)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', background: 'var(--border)', border: '1px solid var(--border)' }}>
          {[
            ...
            { title: 'Soporte técnico', desc: 'Primero nivel de soporte resuelto por el bot. Solo escala lo que realmente necesita intervención humana.' },
