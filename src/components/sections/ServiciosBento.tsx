  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto" style={{ overflowX: "clip", overflowY: "visible" }}>
        <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide px-6 lg:px-8 pb-4 pt-2 md:grid md:grid-cols-2 md:overflow-visible lg:grid-cols-3">
          {CARDS.map((card) => {
