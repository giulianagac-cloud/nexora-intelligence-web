      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 reveal">
          ...
          <BentoCard
            ...
            tagline="Sitios que convierten"
            bullets={["Diseño moderno y responsive", "Identidad profesional", "Performance optimizado"]}
            hoverReveal="→ Landing page que triplicó conversiones en 60 días"
          ...
          <BentoCard
            ...
            hoverReveal="→ Sistema de turnos que eliminó 90% de llamadas"
          />
          ...
          <BentoCard
            ...
            hoverReveal="→ Automatización que ahorró 20hs/sem en reportes"
          />
          ...
          <BentoCard
            ...
            hoverReveal="→ Bot HR: 847 consultas resueltas en 30 días"
          />
          ...
          <BentoCard
            ...
            hoverReveal="→ Consultoría que detectó cuello de botella en facturación"
          ...
          {/* g) En construcción */}
          <div
            className="flex flex-col gap-4 p-7 rounded-xl border-2 border-dashed border-nexora-border/60 sm:col-span-2 lg:col-span-2"
          ...
          >
            ...
            <ul className="flex flex-col gap-1.5">
              {["Capacitación IA", "Legal + Finanzas", "[Tu próximo proyecto]"].map((item) => (
                <li
                  key={item}
                  className="text-[13px]"
